    ...
    forms: {
        ...
        mediaForm: {
            labels: {
                ...
                imageNumber: "Imagen {n}",
                isEditable: "Editable",
                jsonFile: "Archivo JSON",
                editPrices: "Editar precios",
                jsonFields: "Campos de texto editables",
                jsonFilePreview: "Vista previa del archivo JSON",
            },
            owner: {
                you: "Tú",
            ...
            errors: {
                ...
                mustSelectJson: "Debes seleccionar un archivo JSON si es editable",
                jsonOnlyJson: "Solo se permiten archivos .json",
            ...
            hints: {
                ...
                keepJson: "Deja este campo vacío si no quieres cambiar el archivo JSON.",
                adminOnlyEditable: "Solo administradores pueden marcar imágenes como editables.",
            },
        },
        business: {
            labels: {
