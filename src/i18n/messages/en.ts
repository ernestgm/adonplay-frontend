    ...
    forms: {
        ...
        mediaForm: {
            labels: {
                ...
                jsonFields: "Editable text fields",
                jsonFilePreview: "JSON file preview",
            },
            owner: {
                you: "You",
            ...
            errors: {
                ...
                mustSelectJson: "You must select a JSON file if it's editable",
                jsonOnlyJson: "Only .json files are allowed",
            ...
            hints: {
                ...
                keepJson: "Leave this field empty if you don't want to change the existing JSON file.",
                adminOnlyEditable: "Only administrators can mark images as editable.",
            },
        },
        business: {
            labels: {
